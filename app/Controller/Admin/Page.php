...
class Page{
	...
	private static $modulesCadastro = [
		'usuarios' =>[
				'label' => 'Usuários',
				'link' => URL.'/user'
		],
	...
	public static function getPage($title, $content, $menuCadastro, $menuPonto){
		...
		return View::render('pages/page',[
				...
				'title' => $title,
				'content' => $content,
				'user' => @$_SESSION['user']['nome'].' ('.@$_SESSION['user']['tipo']->nome.')',
	...
	//Método responsável por renderizar a view do menu de Cadastro do painel
	private static function getMenuCadastro($currentModule){
		//Links do Menu de Cadastro
		$linksCadastro ='';
		//Itera os módulos
		foreach (self::$modulesCadastro as $hash=>$module){
	...
	public static function getPanel($title, $content, $currentModule){
		...
		$menuCadastro = self::getMenuCadastro($currentModule);
